...
######################## Community ##################    
    ...
    url(r'^useractivities/([0-9]{1,7})$', 'nabbeshreports.maps.views.user_report'),
    #url(r'^useractivities$', 'nabbeshreports.maps.views.user_report'),
...
#################### Finance ##########################    
    ...
    url(r'^revenue_getdata$', 'nabbeshreports.maps.views.revenue_getdata'),
    url(r'^revenue$', 'nabbeshreports.maps.views.revenue_report'),
...
################## Totals #############################
    ...
    url(r'^totaljobs_getdata$', 'nabbeshreports.maps.views.total_jobs_getdata'),
    url(r'^totalskills_getdata$', 'nabbeshreports.maps.views.total_skills_getdata'),          
    url(r'^totalproposals_getdata$', 'nabbeshreports.maps.views.total_proposals_getdata'),    
    ...
    url(r'^totalescrow_getdata$', 'nabbeshreports.maps.views.total_escrow_getdata'),    
...
#######################################################    
    ...
    url(r'^crm_notes_delete$', 'nabbeshreports.maps.views.crm_notes_delete'),
    ...
    url(r'^getcategoriestree$', 'nabbeshreports.maps.views.getcategoriestree'),
    url(r'^getcategoriesbubbles$', 'nabbeshreports.maps.views.getcategoriesbubbles'),
    ...
    url(r'^suggestcategory$', 'nabbeshreports.maps.views.suggestcategory'),  
